...
class Settings:
    ...
    nango_gmail_integration_id: str = field(default_factory=lambda: os.getenv("NANGO_GMAIL_INTEGRATION_ID", "estimoto-plus-gmail"))
    ...
    youtube_enabled: bool = field(default_factory=lambda: os.getenv("YOUTUBE_ENABLED", "false").lower() == "true")
    youtube_api_key: str = field(default_factory=lambda: os.getenv("YOUTUBE_API_KEY", ""), repr=False)
    youtube_daily_requests: int = field(default_factory=lambda: int(os.getenv("YOUTUBE_DAILY_REQUESTS", "80")))
